def add_config(cfg):
    ...
    # 5 3 6 10
    cfg.MODEL.KD_WEIGHT = 5.0
    cfg.MODEL.KD_ALPHA = 3.0
    cfg.MODEL.KD_BETA = 6.0
    cfg.MODEL.KD_TEMPERATURE = 10.0
    # 5 2 4 10
    # cfg.MODEL.KD_WEIGHT = 5.0
    # cfg.MODEL.KD_ALPHA = 3.0
    # cfg.MODEL.KD_BETA = 2.0
    # cfg.MODEL.KD_TEMPERATURE = 20.0
    # 3 2 4 5
    # cfg.MODEL.KD_WEIGHT = 3.0
    # cfg.MODEL.KD_ALPHA = 2.0
    # cfg.MODEL.KD_BETA = 4.0
    # cfg.MODEL.KD_TEMPERATURE = 5.0

    cfg.MODEL.AUX_CE = 0.2
    cfg.MODEL.AUX_NC_CE = 0.01
    ...
    cfg.TEST.MASK = 1  # 0: no mask,a 1: mask unseen clsses, 2: mask prev and unseen classes
