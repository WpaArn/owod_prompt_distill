...
def get_parser():
    ...
    parser.add_argument(
        ...
        # default=['MODEL.WEIGHTS', 'output/M-OWODB/exp21/model_0109999.pth'],
        # default=['MODEL.WEIGHTS', 'output/M-OWODB/exp21/model_0034999.pth'],
        default=['MODEL.WEIGHTS', 'output/ori/ori.pth'],
        # default=['MODEL.WEIGHTS', 'output/ori/rand.pth'],
